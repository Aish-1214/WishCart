      ...
      >
        ...
        <Grid item xs={12} md={6} sx={{ display: "flex", alignItems: "center" }}>
          <Box sx={{ textAlign: "justify", px: 3 }}>
            ...
            >
              Wish <span style={{ color: "#5a0c4a" }}>Cart</span>
            </Typography>
            ...
            >
              Welcome to <strong>WishCart</strong>, your one-stop destination for *quality products at unbeatable prices*.  
            ...
            >
              ...
              Thank you for choosing <strong>WishCart</strong> – Happy Shopping! 🎉
            </Typography>
          </Box>
        </Grid>
      </Grid>
