...
const Footer = () => {
  return (
    ...
    >
      <Grid container spacing={2} alignItems="center">
        ...
        <Grid item xs={12} md={4} sx={{ textAlign: { xs: "center", md: "left" } }}>
          <img
            ...
            src="/logo1-removebg-preview.png" // Ensure this file is inside "public" folder
            alt="logo"
          />
        ...
        <Grid item xs={12} md={8} sx={{ textAlign: "right" }}>
          ...
          <Box sx={{ mt: 1, display: "flex", justifyContent: "flex-end", gap: 4 }}>
            {["Home", "About", "Shop"].map((item, index) => (
              <Link
                key={index}
                to={`/${item.toLowerCase()}`} // ✅ Fixed error here
                style={{
                  textDecoration: "none",
                  fontWeight: "bold",
                  fontSize: "16px",
      ...
      >
        &copy; {new Date().getFullYear()} WishCart. All Rights Reserved.
      </Typography>
    </Paper>
  );
};
